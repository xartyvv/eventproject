...
// CriterionName — список названий всех 15 критериев для МАИ
...
// Matrix9x9 представляет матрицу парных сравнений 9x9 (для 9 критериев)
// Для полного МАИ с 15 критериями используется матрица 15x15
type Matrix15x15 [15][15]float64
